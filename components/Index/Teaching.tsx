        ...
        <div className='row align-items-center'>
          <div className='col-lg-6'>
            <div className='teaching-content mr-15'>
              ...
              <p>
                Instructors from around the world teach millions of students on Edmy. We provide the tools and skills to teach what you
              ...
              <Link href='/become-an-instructor'>
                <a className='default-btn'>Become An Instructor</a>
              </Link>
            </div>
          </div>
          ...
          <div className='col-lg-6'>
            <div className='teaching-img ml-15'>
              <img src='/images/teaching-img-shape.png' className='teaching-img-shape' alt='teaching' />
