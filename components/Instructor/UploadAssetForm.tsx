      ...
      <div className='row'>
        ...
        <div className='col-md-6'>
          <div className='form-group'>
            ...
            <input type='file' className='form-control file-control' name='lecture_file' onChange={handleChange} required={true} />
            <div className='form-text'>Upload file size less than or equal 5MB!</div>
          </div>
        </div>

        <div className='col-12'>
          <Button loading={loading} disabled={loading || disabled} btnText='Upload Asset' btnClass='default-btn' />
        </div>
      </div>
    </form>
  );
