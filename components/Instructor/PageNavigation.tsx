      ...
      <ul className='nav-style1'>
        ...
        <li>
          <Link href={`/instructor/course/edit/${courseId}`}>
            <a className={activeClassname == 'edit' ? 'active' : ''}>Edit Course</a>
          </Link>
        </li>
        <li>
          <Link href={`/instructor/course/upload/${courseId}`}>
            <a className={activeClassname == 'upload' ? 'active' : ''}>Upload Video</a>
          </Link>
        </li>
        <li>
          <Link href={`/instructor/course/uploads/${courseId}`}>
            <a className={activeClassname == 'uploads' ? 'active' : ''}>Videos</a>
          </Link>
        </li>
        <li>
          <Link href={`/instructor/course/assets/${courseId}`}>
            <a className={activeClassname == 'assets' ? 'active' : ''}>Assets</a>
          </Link>
        </li>
      </ul>
    </>
