            ...
            <div className='col-lg-6'>
              <div className='register-form'>
                {register == 'register' ? (
                  ...
                  <motion.h2 initial={{ scale: 0 }} animate={{ scale: 0.9, x: 0 }} exit={{ scale: 1 }}>
                    Sign in to Edmy
                  </motion.h2>
                )}

                <ul className='register-tab nav nav-tabs justify-content-between' data-ison={isOn} onClick={toggleSwitch}>
                  <li className='nav-item' role='presentation'>
                    <motion.button
                      className={`nav-link ${register == 'register' ? 'active' : ''}`}
                  ...
                  <li className='nav-item' role='presentation'>
                    <motion.button
                      className={`nav-link ${register == 'login' ? 'active' : ''}`}
                      type='button'
