...
const RegisterForm = () => {
  ...
  return (
    <motion.form onSubmit={handleSubmit} initial={{ scale: 0 }} animate={{ scale: 1 }} exit={{ scale: 0 }}>
      ...
      <Button loading={loading} disabled={disabled} btnText='Register Now' btnClass='default-btn' />
    </motion.form>
  );
};
