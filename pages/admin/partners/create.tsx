                ...
                <form onSubmit={handleSubmit}>
                  <div className='row'>
                    ...
                    <div className='col-md-12'>
                      <div className='form-group'>
                        ...
                        <input
                          ...
                          required={true}
                        />
                        <div className='form-text'>Upload image size 150x60!</div>

                        <div className='mt-2'>
                          {imagePreview ? (
                            <img src={imagePreview} alt='image' className='img-thumbnail w-100px me-2' />
                          ) : (
                            <img src='/images/partner/partner-1.png' alt='image' className='img-thumbnail w-100px me-2' />
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='col-12'>
                      <Button loading={loading} disabled={disabled} btnText='Save' btnClass='default-btn' />
                    </div>
                  </div>
                </form>
              </div>
