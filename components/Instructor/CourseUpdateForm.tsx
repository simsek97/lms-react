...
import controls from '@/utils/CourseRteEditor';
      ...
      <div className='row'>
        ...
        <div className='col-md-6'>
          <div className='form-group'>
            ...
            <input type='file' className='form-control file-control' name='image' onChange={handleChange} />
        ...
        <div className='col-md-12'>
          <div className='form-group'>
            ...
            <textarea className='form-control' name='short_desc' value={course.short_desc} onChange={handleChange} />
        ...
        <div className='col-12'>
          <Button loading={loading} disabled={disabled} btnText='Update Course' btnClass='default-btn' />
        </div>
      </div>
    </form>
  );
